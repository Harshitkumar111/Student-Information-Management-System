...
<form name="form1" method="POST" action="Admin_login_handler.php" id="Admil_login_handler" >
...
<td colspan="2" class="stylebig">Administrator Login Here</td>
</tr>
 
<tr bgcolor="#E1E1E1" class="stylesmall">
<td width="35%" align="left" class="style7">Login Id : </td>
<td width="65%" align="left"><input name="user_id" type="text" id="user_id"></td>
</tr>
<tr bgcolor="#E1E1E1" class="stylesmall">
